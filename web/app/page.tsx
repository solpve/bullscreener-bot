...
import { bpsToPercent, formatInt, shortenAddress } from "@/lib/format";
    ...
    <>
      ...
      <section className="hero">
        <div className="shell">
          ...
          <div className="tokenhero">
            <div className="tokenhero__copy">
              <h1>
            ...
            {/* The identity sits with the chart it labels, not over the
                headline: the logo, ticker and mint are what the series below
                is a picture of. */}
            <div className="tokenhero__market">
      ...
      <section className="section">
        <div className="shell">
          <div className="section__head">
            <h2 className="section__title">The thesis</h2>
      ...
      <section className="section">
        <div className="shell">
          <div className="section__head">
            <h2 className="section__title">The burn engine</h2>
            <span className="section__note">
      ...
      <section className="section">
        <div className="shell">
          <div className="section__head">
            <h2 className="section__title">Scoreboard</h2>
            <span className="section__note">
